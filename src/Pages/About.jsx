...
<p className="text-xl text-purple-800 font-bold ">GadgetHeaven.com</p>
...
<div className="text-center space-y-3">
  ...
  <p>Call our customer service hotline at <span className="text-red-600 font-bold">10000</span></p>
  <p>Email us at <span className="text-red-600 font-bold">info@gadgetheaven.com</span></p>
</div>
      </div>
    </>
  );
